...
export function createCard(item) {
    ...
    // Verifica se é uma série checando o badge
    const isSeries = item.badge && (item.badge.includes('Nova temporada') || item.badge.includes('Novo episódio'));
    const durationHTML = isSeries ? item.badge : "Clássico";
